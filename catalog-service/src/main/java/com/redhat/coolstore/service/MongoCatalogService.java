...
public class MongoCatalogService implements CatalogService {
    ...
    static {
        DEFAULT_PRODUCT_LIST.add(new Product("329299", "Red Fedora", "<img class='img-responsive img-circle' ng-src='/app/imgs/Sale-600x600_1024x1024.jpg' src='/app/imgs/Sale-600x600_1024x1024.jpg'>\n Official Red Hat Fedora", 34.99));
